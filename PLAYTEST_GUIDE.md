...
Current visible build label: `Prototype v0.5Q`.

This is a small prototype, not a finished game. Please note what confused you, what felt fun, and if anything broke.

## Quick start

1. Open the link in a desktop browser first if possible. Mobile browser play is experimental but now has a more aggressive real-phone HUD: portrait uses stacked skills, and landscape uses a much wider action panel.
...
- Purple intent markers warn about delayed pressure, AP drain, or MP bind effects. Tap/check the tile and read the message panel for details.
