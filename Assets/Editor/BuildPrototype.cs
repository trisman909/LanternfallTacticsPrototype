    ...
    public static class BuildPrototype
    {
        ...
        static void PatchWebGLForResponsivePreview(string path)
        {
            ...
            if(File.Exists(index))
            {
                ...
                html=html.Replace("href=\"TemplateData/style.css\"","href=\"TemplateData/style.css?v=6N1LHUD2\"");
                html=html.Replace("var loaderUrl = buildUrl + \"/LanternfallTactics.loader.js\";","var cacheBust = \"v=6N1LHUD2\";\n      var loaderUrl = buildUrl + \"/LanternfallTactics.loader.js?\" + cacheBust;");
