...
namespace Lanternfall.EditorTools
{
    public static class BuildPrototype
    {
        ...
        static void ConfigureMobileFriendlyDefaults()
        {
            ...
            PlayerSettings.bundleVersion="0.6.14";
        ...
        static void PatchWebGLForResponsivePreview(string path)
        {
            ...
            if(File.Exists(index))
            {
                ...
                html=html.Replace("var loaderUrl = buildUrl + \"/LanternfallTactics.loader.js\";","var cacheBust = \"v=6K1\";\n      var loaderUrl = buildUrl + \"/LanternfallTactics.loader.js?\" + cacheBust;");
                ...
                html=html.Replace("<div id=\"unity-progress-bar-empty\">","<div id=\"lanternfall-loading-copy\">Loading Lanternfall Tactics - Prototype v0.6K.1 tactical-clarity build. First phone load may be slow; repeat loads can use browser caching. Rotate your phone to landscape; Add to Home Screen/fullscreen is best if available.</div>\n        <div id=\"unity-progress-bar-empty\">");
