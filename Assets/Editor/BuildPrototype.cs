...
namespace Lanternfall.EditorTools
{
    public static class BuildPrototype
    {
        ...
        static void ConfigureMobileFriendlyDefaults()
        {
            ...
            PlayerSettings.bundleVersion="0.6N.2+"+GitShortHash();
        ...
        static void PatchWebGLForResponsivePreview(string path)
        {
            ...
            if(File.Exists(index))
            {
                ...
                html=html.Replace("href=\"TemplateData/style.css\"","href=\"TemplateData/style.css?v=6N2QA\"");
                html=html.Replace("var loaderUrl = buildUrl + \"/LanternfallTactics.loader.js\";","var cacheBust = \"v=6N2QA\";\n      var loaderUrl = buildUrl + \"/LanternfallTactics.loader.js?\" + cacheBust;");
                ...
                html=html.Replace("<body>","<body>\n    <div id=\"lanternfall-build-proof\">Phase 6N.2 — HUD QA</div>\n    <div id=\"lanternfall-rotate-overlay\" aria-live=\"polite\">\n      <div class=\"lanternfall-rotate-card\">\n        <div class=\"lanternfall-rotate-title\">Rotate your phone to play</div>\n        <div class=\"lanternfall-rotate-body\">Lanternfall Tactics is best played in landscape.</div>\n        <div class=\"lanternfall-rotate-note\">Add to Home Screen for more space.</div>\n      </div>\n    </div>");
                html=html.Replace("<div id=\"unity-progress-bar-empty\">","<div id=\"lanternfall-loading-copy\">Loading Lanternfall Tactics - Prototype v0.6N.2 mobile-HUD build. Audio unlocks after your first tap. Rotate your phone to landscape; Add to Home Screen/fullscreen is best if available.</div>\n        <div id=\"unity-progress-bar-empty\">");
