    ...
    public static class BuildPrototype
    {
        ...
        static void PatchWebGLForResponsivePreview(string path)
        {
            ...
            if(File.Exists(index))
            {
                ...
                html=html.Replace("var loaderUrl = buildUrl + \"/LanternfallTactics.loader.js\";","var cacheBust = \"v=6C\";\n      var loaderUrl = buildUrl + \"/LanternfallTactics.loader.js?\" + cacheBust;");
                ...
                html=html.Replace("<div id=\"unity-progress-bar-empty\">","<div id=\"lanternfall-loading-copy\">Loading Lanternfall Tactics - Prototype v0.6C icon foundation. First phone load may be slow; repeat loads can use browser caching. Rotate your phone to landscape; Add to Home Screen/fullscreen is best if available.</div>\n        <div id=\"unity-progress-bar-empty\">");
