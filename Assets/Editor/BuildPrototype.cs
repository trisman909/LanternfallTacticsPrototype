...
namespace Lanternfall.EditorTools
{
    public static class BuildPrototype
    {
        ...
        static void ConfigureMobileFriendlyDefaults()
        {
            ...
            PlayerSettings.bundleVersion="0.6N.3+"+GitShortHash();
        ...
        static void PatchWebGLForResponsivePreview(string path)
        {
            ...
            if(File.Exists(index))
            {
                ...
                html=html.Replace("href=\"TemplateData/style.css\"","href=\"TemplateData/style.css?v=6N3QA\"");
                html=html.Replace("var loaderUrl = buildUrl + \"/LanternfallTactics.loader.js\";","var cacheBust = \"v=6N3QA\";\n      var loaderUrl = buildUrl + \"/LanternfallTactics.loader.js?\" + cacheBust;");
                ...
                html=html.Replace("      // By default, Unity keeps WebGL canvas render target size matched with", "      config.devicePixelRatio = 1;\n\n      // By default, Unity keeps WebGL canvas render target size matched with");
                ...
                html=html.Replace("<div id=\"unity-progress-bar-empty\">","<div id=\"lanternfall-loading-copy\">Loading Lanternfall Tactics - Prototype v0.6N.3 real-device HUD review build. Audio unlocks after your first tap. Rotate your phone to landscape; Add to Home Screen/fullscreen is best if available.</div>\n        <div id=\"unity-progress-bar-empty\">");
