...
namespace Lanternfall.EditorTools
{
    public static class BuildPrototype
    {
        ...
        static void ConfigureMobileFriendlyDefaults()
        {
            ...
            PlayerSettings.bundleVersion="0.5.13";
        ...
        static void PatchWebGLForResponsivePreview(string path)
        {
            ...
            if(File.Exists(index))
            {
                ...
                html=html.Replace("var loaderUrl = buildUrl + \"/LanternfallTactics.loader.js\";","var cacheBust = \"v=5Q\";\n      var loaderUrl = buildUrl + \"/LanternfallTactics.loader.js?\" + cacheBust;");
                ...
                html=html.Replace("<div id=\"unity-progress-bar-empty\">","<div id=\"lanternfall-loading-copy\">Loading Lanternfall Tactics - Prototype v0.5Q real phone HUD + enemy AI fix. First phone load may be slow; repeat loads can use browser caching. Rotate or use browser fullscreen/Add to Home Screen if controls feel cramped.</div>\n        <div id=\"unity-progress-bar-empty\">");
