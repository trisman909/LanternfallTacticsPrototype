...
namespace Lanternfall
{
    ...
    public static class SkillBook
    {
        public static readonly SkillDefinition[] All =
        {
            ...
            new(){Id=SkillId.SunCharge,ClassId=PlayerClassId.Vanguard,Name="Sun Charge",Range=3,Cooldown=2,ApCost=4,Damage=2,Effect=SkillEffect.DashDamage,RequiresLineOfSight=false,Hint="4 AP - charge and push"},

            new(){Id=SkillId.StraightShot,ClassId=PlayerClassId.Wayfinder,Name="Straight Shot",Range=5,Cooldown=0,ApCost=3,Damage=3,Effect=SkillEffect.Damage,Hint="3 AP - line shot"},
            new(){Id=SkillId.MarkedTarget,ClassId=PlayerClassId.Wayfinder,Name="Marked Target",Range=5,Cooldown=1,ApCost=2,Damage=0,Effect=SkillEffect.Mark,Hint="2 AP - mark for bonus damage"},
            new(){Id=SkillId.PiercingPrism,ClassId=PlayerClassId.Wayfinder,Name="Piercing Prism",Range=6,Cooldown=2,ApCost=5,Damage=4,Effect=SkillEffect.Damage,Hint="5 AP - strong line hit"},
            ...
            new(){Id=SkillId.DelayedBlast,ClassId=PlayerClassId.Cantor,Name="Delayed Blast",Range=4,Cooldown=3,ApCost=5,Damage=4,Effect=SkillEffect.DelayedArea,RequiresLineOfSight=false,Hint="5 AP - preview, then blast"},
            ...
            new(){Id=SkillId.Backstab,ClassId=PlayerClassId.Gloamstep,Name="Backstab",Range=1,Cooldown=0,ApCost=4,Damage=4,Effect=SkillEffect.Damage,Hint="4 AP - close burst"},
            new(){Id=SkillId.ShadowSwap,ClassId=PlayerClassId.Gloamstep,Name="Shadow Swap",Range=4,Cooldown=2,ApCost=3,Damage=0,Effect=SkillEffect.Swap,Hint="3 AP - swap with foe"},

            new(){Id=SkillId.LensTrap,ClassId=PlayerClassId.Artificer,Name="Lens Trap",Range=4,Cooldown=1,ApCost=3,Damage=1,Effect=SkillEffect.Root,Hint="3 AP - root target"},
